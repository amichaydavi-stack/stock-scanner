...
def get_stock_universe():
    tickers = [
        ...
        "WFC","C","AXP","BX","KKR","APO","XOM","CVX","COP","EOG",
        "SLB","MPC","PSX","VLO","OXY","HES","LIN","APD","SHW","ECL",
        "DD","DOW","PPG","NUE","FCX","ALB","DIS","CMCSA","CHTR","SPOT",
        "RBLX","EA","UNP","UPS","FDX","CSX","NSC","DAL","UAL","LUV",
        "PFE","BMY","MRNA","BIIB","ILMN","IQV","CRL","AMT","CCI","EQIX",
        "SPG","O","WELL","DLR","PSA","EXR","UBER","LYFT","ABNB","DASH",
        "COIN","HOOD","SQ","PYPL","AFRM","SOFI","NU","MELI","SE","GRAB",
        "ARM","SMCI","DELL","HPE","WDC","STX","NTAP","PSTG","FIVN","NICE",
        "GTLB","PATH","UiPath","DOCN","CFLT","ESTC","SUMO","NEWR","DT","ASAN"
    ]
    # Remove duplicates
    tickers = list(set([t for t in tickers if isinstance(t, str) and t.isalpha() or '-' in str(t)]))
